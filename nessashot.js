...
Item.LIST = {
	...
	ChoiceSpecs: new Item("ChoiceSpecs", [
		...
		], [new DamagingMove("ChoiceSpecs", 0,0.30,0,40, 8),
		    new DamagingMove("ChoiceSpecs", 0,0.35,0,50, 8),
		    new DamagingMove("ChoiceSpecs", 0,0.40,0,60, 8),
		], new MoveItemPassive(Passive.COOLDOWN)),
	DrainCrown: new Item("DrainCrown", [
			new Stats({health:   8, attack:  0}),
			new Stats({health:   8, attack:  1.2}),
			new Stats({health:  16, attack:  1.2}),
			new Stats({health:  16, attack:  2.4}),
			new Stats({health:  24, attack:  2.4}),
			new Stats({health:  24, attack:  3.6}),
			new Stats({health:  32, attack:  3.6}),
			new Stats({health:  32, attack:  4.8}),
			new Stats({health:  40, attack:  4.8}),
			new Stats({health:  40, attack:  6.0}),
			new Stats({health:  48, attack:  6.0}),
			new Stats({health:  48, attack:  7.2}),
			new Stats({health:  56, attack:  7.2}),
			new Stats({health:  56, attack:  8.4}),
			new Stats({health:  64, attack:  8.4}),
			new Stats({health:  64, attack:  9.6}),
			new Stats({health:  72, attack:  9.6}),
			new Stats({health:  72, attack: 10.8}),
			new Stats({health:  80, attack: 10.8}),
			new Stats({health:  80, attack: 12.0}),
			new Stats({health:  88, attack: 12.0}),
			new Stats({health:  88, attack: 13.2}),
			new Stats({health:  96, attack: 13.2}),
			new Stats({health:  96, attack: 14.4}),
			new Stats({health: 104, attack: 14.4}),
			new Stats({health: 104, attack: 15.6}),
			new Stats({health: 112, attack: 15.6}),
			new Stats({health: 112, attack: 16.8}),
			new Stats({health: 120, attack: 16.8}),
			new Stats({health: 120, attack: 18.0}),
		], [0.06, 0.08, 0.10], Passive.DUMMY/*lifesteal on autos*/),
	...
	RapidFireScarf: new Item("RapidFireScarf", [
			new Stats({attack: 0.8, aps: 0.0}),
			new Stats({attack: 0.8, aps: 0.6}),
			new Stats({attack: 1.6, aps: 0.6}),
			new Stats({attack: 1.6, aps: 1.2}),
			new Stats({attack: 2.4, aps: 1.2}),
			new Stats({attack: 2.4, aps: 1.8}),
			new Stats({attack: 3.2, aps: 1.8}),
			new Stats({attack: 3.2, aps: 2.4}),
			new Stats({attack: 4.0, aps: 2.4}),
			new Stats({attack: 4.0, aps: 3.0}),
			new Stats({attack: 4.8, aps: 3.0}),
			new Stats({attack: 4.8, aps: 3.6}),
			new Stats({attack: 5.6, aps: 3.6}),
			new Stats({attack: 5.6, aps: 4.2}),
			new Stats({attack: 6.4, aps: 4.2}),
			new Stats({attack: 6.4, aps: 4.8}),
			new Stats({attack: 7.2, aps: 4.8}),
			new Stats({attack: 7.2, aps: 5.4}),
			new Stats({attack: 8.0, aps: 5.4}),
			new Stats({attack: 8.0, aps: 6.0}),
			new Stats({attack: 8.8, aps: 6.0}),
			new Stats({attack: 8.8, aps: 6.6}),
			new Stats({attack: 9.6, aps: 6.6}),
			new Stats({attack: 9.6, aps: 7.2}),
			new Stats({attack: 10.4, aps: 7.2}),
			new Stats({attack: 10.4, aps: 7.8}),
			new Stats({attack: 11.2, aps: 7.8}),
			new Stats({attack: 11.2, aps: 8.4}),
			new Stats({attack: 12.0, aps: 8.4}),
			new Stats({attack: 12.0, aps: 9.0}),
		], [15,22.5,30], Passive.DUMMY), // Not sure how to implement
	RazorClaw: new Item("RazorClaw", [
		...
		], [new DamagingMove("RazorClaw", 0.40,0,0,10, 1.5),
		    new DamagingMove("RazorClaw", 0.45,0,0,15, 1.5),
		    new DamagingMove("RazorClaw", 0.50,0,0,20, 1.5),
		], new BasicMoveItemPassive()),
	...
	ScopeLens: new Item("ScopeLens", [
		...
		], [new DamagingMove("ScopeLens", 0.45,0,0,0, 1),
		    new DamagingMove("ScopeLens", 0.60,0,0,0, 1),
		    new DamagingMove("ScopeLens", 0.75,0,0,0, 1),
		], new MoveItemPassive(Passive.CRIT)),
	...
	ShellBell: new Item("ShellBell", [
		...
		], [new HealingMove("ShellBell", 0,0.35,0,45, 10),
		    new HealingMove("ShellBell", 0,0.40,0,60, 10),
		    new HealingMove("ShellBell", 0,0.45,0,75, 10),
		], new MoveItemPassive(Passive.COOLDOWN)),
